...
class SMCUpdater(Distribution):
    ...
    def down_sample_particle_filter(self,particle_weights,particle_locations,n_particles):
        """
        ...
        reduced_indices = np.argsort(particle_weights)[::-1][:n_particles]
    ...
    def bayes_risk(self, expparams, use_cached_samples=False,cache_samples=True,
        ...
        if self._dview and ipp is not None:
            ...
            risk = np.concatenate(self._dview.map_sync(
                SMCUpdater._parallel_risk_eval,
                expparams_split,
